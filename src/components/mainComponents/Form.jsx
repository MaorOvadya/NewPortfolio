        ...
        <section className="flex flex-col items-center pb-5 ">
          <div className="flex flex-col pb-5 text-sm">
            ...
            <input
              ...
              className="rounded-[5px] w-[20rem] sm:w-[30rem] lg:w-[40rem] py-1 border-[1px] border-[#222222] bg-inherit px-1 font-light"
            />
        ...
        <section className="flex flex-col text-center items-center text-start">
          ...
          <div className="flex flex-col  pb-10 text-sm">
            ...
            <textarea
              ...
              className=" w-[20rem] sm:w-[30rem] lg:w-[40rem] rounded-[5px] border-[1px] border-[#222222] bg-inherit px-1 font-light"
            ></textarea>
