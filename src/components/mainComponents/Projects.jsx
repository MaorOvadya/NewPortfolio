    ...
    project: (
      <section className="flex">
        ...
        <section className=" text-[#222222] flex flex-col justify-center items-center tracking-wide w-full">
          <div className="text-3xl text-center pb-10 flex">
            Teddies Vs Monster
            <button className=" text-white mx-10 flex items-center gap-5 text-2xl">
              <a
          ...
          <article className="w-[500px] p-5 rounded-md bg-[#C60F52] text-white leading-relaxed text-sm">
          ...
          <div className="w-[500px] my-10 leading-relaxed text-sm">
    ...
    project: (
      <section className="flex ">
        ...
        <section className=" bg-[#222222] text-white flex flex-col justify-center items-center tracking-wide w-full">
          <div className="text-3xl text-center py-20 flex">
            Teddies Vs Monster
            <button className=" text-white mx-10 flex items-center gap-5 text-2xl">
              <a
                className="bg-[#C60F52] p-2 rounded-md"
